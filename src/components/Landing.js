      ...
      <div className="flex flex-col gap-y-8 justify-center items-center h-full">
        ...
        <div className="mt-8">
          <button
            ...
            type="button"
            className="flex cursor-pointer backgroundStarted transform hover:scale-110 hover:shadow-md hover:transition-colors hover:duration-300 hover:ease-in-out hover:shadow-[#d8aef8] border-orange-600 outline-orange-600 rounded-[20px] px-8 py-2.5 mb-4 w-[250px]"
          >
            <span className="text-lg font-medium tracking-wide text-white text-center flex justify-center w-full gap-2">
              Get started
            </span>
          </button>
        </div>
